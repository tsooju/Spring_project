...
public class Board implements java.io.Serializable {
    ...
    private String board_rename_filename; // 첨부파일 변경이름
    private int board_ref;	//참조하는 원글번호 : 원글-자기번호, 댓/대댓글 : 원글번호
	private int board_reply_ref; // 참조하는 댓글번호 : 댓글-자기번호, 대댓글 : 댓글번호
	private int board_lev; // 원글 : 1, 댓글 : 2, 대댓글 : 3
	private int board_reply_seq; // 댓글과 대댓글의 순번 (최근글이 1이 된다.)
