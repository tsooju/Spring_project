...
// notice, board 파일 다운 처리용 뷰클래스
@Component("filedown") // 설정파일에 자동 등록함
public class FileDownloadView extends AbstractView {
	...
	protected void renderMergedOutputModel(
		...
		//Response는 고객의 ip주소 넘겨 온다.
		// 파일 다운로드 처리용 코드 구현한다. 
		// 콘트롤러 메소드에서 리턴한 모델의 값(파일객체)을 추출해서
		...
		//client으로 전송하기 위한 설정해야 함. 이 설정은 가장 중요함. (file ==> plain 란 코드를 사용함)
		...
		// response 로 write() | print() 함 => 이 작업을 스프링에서  제공한다.
