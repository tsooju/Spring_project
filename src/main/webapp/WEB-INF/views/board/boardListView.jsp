...
<body>
	...
	<center>
		<button
			onclick="javascript:location.href='${pageContext.servletContext.contextPath}/blist.do?page=${ currentPage }';">목록
			보기</button>
	</center>
	<br>
	<table align="center" width="700" border="1" cellspacing="0"
		...
		<c:forEach items="${ requestScope.list }" var="b">
			<tr>
				...
				<!-- 게시글제목 클릭시 해당 글의 상세보기로 넘어가게 처리해야 함 -->
				...
				<td><c:if test="${ !empty b.board_original_filename }">◎</c:if>
					<c:if test="${ empty b.board_original_filename }">&nbsp;</c:if></td>
			</tr>
		</c:forEach>
	</table>
	<br>
