...
<!-- form 태그에서 입력된 값들(문자열)과 첨부파일을 같이 전송하려면 
		반드시 : enctype 란 속성을 form 태그에 추가해야 한다. 
		enctype="multipart/form-data" 값을 지정해야 함. 
		:: form tag에 enctype을 추가했으면 method="post"로 지정해야 한다. 
 -->
<form action="binsert.do" method="post"  enctype="multipart/form-data">
	...
	<tr><th>작성자</th><td><input type="text" name="board_writer" readonly value="${ sessionScope.loginMember.userid }"></td></tr>
	...
	<tr><th colspan="2">
		...
		<button onclick="javasctript:history.go(-1); return false;">목록</button>
	</th></tr>
	</table>
</form>
