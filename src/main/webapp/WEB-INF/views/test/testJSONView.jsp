...
<!-- button tag type 속성에 사용하는 값 : button, submit, reset 3까지로 만 사용 가능 
button type는 생략해도 됨.
-->
<!-- 태그에 사용하는 이벤트속성은 자바스크립트가 제공함.  
		해당 이벤트가 태그에 발생했을 때 기능(함수) 작동 방법은 
		1: on이벤트명="함수명();"  
			만약 샐행시킨 함수쪽으로 전달할 값이 있다면 : on이벤트명="함수명(전달값, 전달값);"
		
		2: on이벤트명="javascript:객체명.메소드명(전달값);"  또는 on이벤트명="javascript:객체명.메소드명();" 할 수 있다.
		
		
		** click event는 같은 태그 영역 안에 있는 다른 버튼에게 전달된다. 같이 클릭 동작이 발생한다. 
			그래서 클릭 이벤트가 전달되지 않게 하려면 : on이벤트명="함수명(); return false;" 	
 -->
<script type="text/javascript">
/* 함수를 다음과 같이 만들어준다. */
 // JSON: Javascript Object Notation (자바스크립트 객체 표기법)
 // {}로 묶음, "이름": 값을 한쌍으로 표기함. 
 // "이름" 은 따옴표 묶어서 문자형으로 표기하고, 
 // 값은 자료형에 따라서 표기함. "string", number, boolean, [array] 한다. 
 //여러 개의 항목일때는 , 로 구분함. 
 
 /* var, let, const(상수) 키워드로 선언할 수 있음.*/
 
 //var objectName = {"name" : value, "name": "value", "name": [values]};   ==>> json의 객체 만드는 표기법
 // var은 전역변수
 var member = {
		 "userid": "test007",
		 "username": "홍길동",
 ...
 };   //  json은 {}로 묶는다. 이거는 객체object란 것을 알 수 있다. 
 
 
function jsonTest1(){
	console.log("member : " + member); //[object Object] 과 같이 확인 된다. 
	
	// JSON 객체를 문자열로 변환해서 출력하기 : stringify() 함수를 사용한다. 
	document.getElementById("p1").innerHTML = "<b>JSON 객체를 문자열로 변환해서 출력하기</b><br>"; // p1란 id 명을 가진 tag을 찾아라란 뜻 html 안에 작성하라
	//바로 = 하면 이전에 기능이 사라진다. 그래서 += 라고 표시해준다. 
	...
	document.getElementById("p1").innerHTML += "이름 : " + member.username + "<br>";
	document.getElementById("p1").innerHTML += "나이 : " + member.age + "<br>";
...
<p id="p2" style="width:600px; height:420px; border:1px solid red;" ></p>
...
function jsonTest2(){
	console.log("employee : " + employee); //[object Object] 과 같이 확인 된다. 
	
	// JSON 객체를 문자열로 변환해서 출력하기 : stringify() 함수를 사용한다. 
	document.getElementById("p2").innerHTML = "<b>JSON 객체를 문자열로 변환해서 출력하기</b><br>"; // p1란 id 명을 가진 tag을 찾아라란 뜻 html 안에 작성하라
	//바로 = 하면 이전에 기능이 사라진다. 그래서 += 라고 표시해준다. 
	...
	document.getElementById("p2").innerHTML += "사번 : " + employee.empid + "<br>";
	document.getElementById("p2").innerHTML += "직원명 : " + employee.empname + "<br>";
	document.getElementById("p2").innerHTML += "급여 : " + employee.salary + "<br>";
	...
	document.getElementById("p2").innerHTML += "<br><br><b>JSON 객체가 가진 배열값들을 하나씩 꺼내서 출력하기</b><br>";
...
<hr>
<h2>3. JSON 객체 안에 JSON 객체 객체 다루기</h2>
...
function jsonTest3(){
	console.log("emplist : " + emplist); //[object Object] 과 같이 확인 된다. 
	console.log("emplist.D1 : " + emplist.D1);
	console.log("emplist.D2 : " + emplist.D2);
	// JSON 객체를 문자열로 변환해서 출력하기 : stringify() 함수를 사용한다. 
	document.getElementById("p3").innerHTML = "<b>JSON 객체를 문자열로 변환해서 출력하기</b><br>"; // p1란 id 명을 가진 tag을 찾아라란 뜻 html 안에 작성하라
	//바로 = 하면 이전에 기능이 사라진다. 그래서 += 라고 표시해준다. 
	...
	document.getElementById("p3").innerHTML += "아이다 :" + emplist.D1.empid + "<br>";
	document.getElementById("p3").innerHTML += "직원명 : " + emplist.D1.empname + "<br>";
	document.getElementById("p3").innerHTML += "급여 : " + emplist.D1.salary + "<br>";
	document.getElementById("p3").innerHTML += "취미활동 : " + emplist.D1.hobby + "<br>";
	
	document.getElementById("p3").innerHTML += "<br><b>[D2 부서 직원 정보]</b> <br>";

	document.getElementById("p3").innerHTML += "아이디 : " + emplist.D2.empid + "<br>";
	document.getElementById("p3").innerHTML += "직원명 : " + emplist.D2.empname + "<br>";
	document.getElementById("p3").innerHTML += "급여 : " + emplist.D2.salary + "<br>";
	document.getElementById("p3").innerHTML += "취미활동 : " + emplist.D2.hobby + "<br>";
	
	// 항목의 배열값들을 별도로 하나씩 다루기 
	document.getElementById("p3").innerHTML += "<b>JSON 객체가 가진 배열값들을 하나씩 꺼내서 출력하기</b><br>";
...
<hr>
<h2>4. JSON 객체 안에 JSON 계층형 계단씩 다단계 하위 객체 다루기</h2>
...
function jsonTest4(){
	console.log("emphier : " + emphier); //[object Object] 과 같이 확인 된다. 
	console.log("emphier.D1 : " + emphier.D1);
	console.log("emphier.D1.J1 : " + emphier.D1.J1);
	console.log("emphier.D1.J2 : " + emphier.D1.J2);
	
	// JSON 객체를 문자열로 변환해서 출력하기 : stringify() 함수를 사용한다. 
	document.getElementById("p4").innerHTML = "<b>JSON 객체를 문자열로 변환해서 출력하기</b><br>"; // p1란 id 명을 가진 tag을 찾아라란 뜻 html 안에 작성하라
	//바로 = 하면 이전에 기능이 사라진다. 그래서 += 라고 표시해준다. 
	...
	document.getElementById("p4").innerHTML += "아이다 :" + emphier.D1.J1.empid + "<br>";
	document.getElementById("p4").innerHTML += "직원명 : " + emphier.D1.J1.empname + "<br>";
	document.getElementById("p4").innerHTML += "급여 : " + emphier.D1.J1.salary + "<br>";
	document.getElementById("p4").innerHTML += "취미활동 : " + emphier.D1.J1.hobby + "<br>";
	
	document.getElementById("p4").innerHTML += "<br><b>[D2 부서 J2 직급 직원 정보]</b> <br>";

	document.getElementById("p4").innerHTML += "아이디 : " + emphier.D1.J2.empid + "<br>";
	document.getElementById("p4").innerHTML += "직원명 : " + emphier.D1.J2.empname + "<br>";
	document.getElementById("p4").innerHTML += "급여 : " + emphier.D1.J2.salary + "<br>";
	document.getElementById("p4").innerHTML += "취미활동 : " + emphier.D1.J2.hobby + "<br>";
	
	// 항목의 배열값들을 별도로 하나씩 다루기 
	document.getElementById("p4").innerHTML += "<br><br><b>JSON 객체가 가진 배열값들을 하나씩 꺼내서 출력하기</b><br>";
...
<hr>
<h2>5. JSON 객체 안에 JSON 계층형 계단씩 다단계 하위 객체를 배열 다루기</h2>
...
function jsonTest5(){
	console.log("emphier2 : " + emphier2); //[object Object] 과 같이 확인 된다. 
	console.log("emphier2.D1 : " + emphier2.D1);
	console.log("emphier2.D1['J1'] : " + emphier2.D1["J1"]);
	console.log("emphier2.D1['J2'] : " + emphier2.D1["J2"]);
	
	// JSON 객체를 문자열로 변환해서 출력하기 : stringify() 함수를 사용한다. 
	document.getElementById("p5").innerHTML = "<b>JSON 객체를 문자열로 변환해서 출력하기</b><br>"; // p1란 id 명을 가진 tag을 찾아라란 뜻 html 안에 작성하라
	//바로 = 하면 이전에 기능이 사라진다. 그래서 += 라고 표시해준다. 
	document.getElementById("p5").innerHTML += JSON.stringify(emphier2); 
	document.getElementById("p5").innerHTML += JSON.stringify(emphier2.D1); 
	...
	document.getElementById("p5").innerHTML += "아이다 :" + emphier2.D1["J1"].empid + "<br>";
	document.getElementById("p5").innerHTML += "직원명 : " + emphier2.D1["J1"].empname + "<br>";
	document.getElementById("p5").innerHTML += "급여 : " + emphier2.D1["J1"].salary + "<br>";
	document.getElementById("p5").innerHTML += "취미활동 : " + emphier2.D1["J1"].hobby + "<br>";
	
	document.getElementById("p5").innerHTML += "<br><b>[D2 부서 J2 직급 직원 정보]</b> <br>";

	document.getElementById("p5").innerHTML += "아이디 : " + emphier2.D1["J2"].empid + "<br>";
	document.getElementById("p5").innerHTML += "직원명 : " + emphier2.D1["J2"].empname + "<br>";
	document.getElementById("p5").innerHTML += "급여 : " + emphier2.D1["J2"].salary + "<br>";
	document.getElementById("p5").innerHTML += "취미활동 : " + emphier2.D1["J2"].hobby + "<br>";
	
	// 항목의 배열값들을 별도로 하나씩 다루기 
	document.getElementById("p5").innerHTML += "<br><br><b>JSON 객체가 가진 배열값들을 하나씩 꺼내서 출력하기</b><br>"
...
function jsonTest6(){
	console.log("empArray : " + empArray); //[object Object] 과 같이 확인 된다. 
	console.log("empArray.D1 : " + empArray.D1);
	console.log("empArray.D1[0] : " + empArray.D1[0]);
	console.log("empArray.D1[1] : " + empArray.D1[1]);
	
	// JSON 객체를 문자열로 변환해서 출력하기 : stringify() 함수를 사용한다. 
	document.getElementById("p6").innerHTML = "<b>JSON 객체를 문자열로 변환해서 출력하기</b><br>"; // p1란 id 명을 가진 tag을 찾아라란 뜻 html 안에 작성하라
	//바로 = 하면 이전에 기능이 사라진다. 그래서 += 라고 표시해준다. 
	...
	document.getElementById("p6").innerHTML += JSON.stringify(empArray.D1[0]); 
	document.getElementById("p6").innerHTML += JSON.stringify(empArray.D1[1]); 
	...
	for(var i in empArray.D1){
		document.getElementById("p6").innerHTML += "아이다 :" + empArray.D1[i].empid + "<br>";
		document.getElementById("p6").innerHTML += "직원명 : " + empArray.D1[i].empname + "<br>";
		document.getElementById("p6").innerHTML += "급여 : " + empArray.D1[i].salary + "<br>";
